...
//---------------by Brajesh--------------------------------------------------------------------------------
#define bitRead(value, bitPos) (((value) >> (bitPos)) & 0x01)
#define bitSet(value, bitPos) ((value) |= (1UL << (bitPos)))
#define bitClear(value, bitPos) ((value) &= ~(1UL << (bitPos)))
#define bitWrite(value, bitPos, bitvalue) ((bitvalue) ? bitSet(value, bitPos) : bitClear(value, bitPos))
//----------------------------------------------------------------------------------------------------------
